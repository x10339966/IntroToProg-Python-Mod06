...
class Processor:
    ...
    @staticmethod
    def add_data_to_list(strTask, strPriority, lstTable):
        # TODO: Add Code Here!
    ...
    @staticmethod
    def remove_data_from_list(strTask, lstTable):
        # TODO: Add Code Here!
        for dicRow in lstTable:
            if strTask.lower() == dicRow["Task"].lower():
                lstTable.remove(dicRow)
        return lstTable, 'Success'

    @staticmethod
    def write_data_to_file(strFileName, lstTable):
        # TODO: Add Code Here!
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        Processor.add_data_to_list(tplData[0],tplData[1],lstTable)
        ...
        Processor.remove_data_from_list(IO.input_task_to_remove(),lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
